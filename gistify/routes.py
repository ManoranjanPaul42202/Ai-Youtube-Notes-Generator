...
from gistify.form import RegistrationForm, loginForm, UpdateAccountForm
...
@app.route("/home")
def hello():
    return render_template('home.html', data=data, title="Gistify - AI YouTube Notes Generator", css='home.css')
